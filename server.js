...
function connectSocket() {
  ...
  async function saveData(data) {
    ...
    try {
        const {
            _id, betAmount, balanceType, currency, closedOut, closeoutComplete, paidOut,
            ranHooks, attempts, betId, gameName, gameNameDisplay, transactionIds,
            thirdParty, category, gameIdentifier, payoutValue, mult, profit,
            gameSessionId, userId, won, timestamp, closeoutTimestamp,
            username, twoFactor, ...otherData
        } = data;
        ...
        const betParams = [
            ...
            closedOut || null, closeoutComplete || null, paidOut || null, ranHooks || null,
